<div class="mt-20 w-full p-8 flex flex-col items-center bg-white">
    ...
    <section class="py-10 px-6 bg-blue-100 rounded-lg drop-shadow-lg">
      <div class="w-full mx-auto bg-white p-8 rounded-lg shadow-lg"> 
        <h1 class="text-xl font-bold font-poppins text-blue-700 mb-6">Berikan Feedback Anda</h1>
          ...
          <div class="w-full md:h-1/2">
            ...
            <form action="{{ route('send.feedback') }}" method="POST" class="space-y-4">
              ...
              <div>
                ...
                <input type="text" id="name" name="name" required class="mt-1 block w-full px-2 py-1 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" placeholder="Nama:">
              </div>

              <div>
                <label for="message" class="block text-sm font-medium text-gray-700">Feedback Anda:</label>
                <textarea name="message" id="message" rows="3" required class="mt-1 block w-full px-2 py-1 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" placeholder="Feedback Anda:"></textarea>
              </div>
